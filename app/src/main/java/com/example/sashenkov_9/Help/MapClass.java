...
public class MapClass {
    ...
    public void GetMapsInfo(String userName, String email, String password1, String password2, RegisterCallback callback) {
        ...
        Log.d(TAG, "Request URL: " + BASE_URL + "/api/v1/auth/maps-in-users/SaveList");
